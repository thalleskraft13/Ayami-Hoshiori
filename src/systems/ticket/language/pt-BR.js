...
module.exports = [
  ...
  { id: "claim_status_none", render: () => "👤 **Responsável:** Ninguém ainda" },
  { id: "claim_status_set", render: (ctx) => `👤 **Responsável:** <@${ctx.userId}>` },
  { id: "btn_claim", render: () => "🖐️ Assumir Ticket" },
  { id: "btn_unclaim", render: () => "🔓 Liberar Ticket" },
  { id: "btn_transfer", render: () => "🔄 Transferir" },
  { id: "claim_no_permission", render: () => "❌ Você não tem permissão para assumir este ticket." },
  { id: "claim_already_claimed", render: (ctx) => `${ctx.emburrada} Este ticket já foi assumido por <@${ctx.userId}>.` },
  { id: "claim_success", render: (ctx) => `${ctx.feliz} <@${ctx.userId}> assumiu este ticket.` },
  { id: "unclaim_no_permission", render: () => "❌ Você não tem permissão para liberar este ticket." },
  { id: "unclaim_not_claimed", render: () => "Este ticket ainda não tem responsável." },
  { id: "unclaim_success", render: (ctx) => `🔓 <@${ctx.userId}> liberou este ticket.` },
  { id: "transfer_no_permission", render: () => "❌ Você não tem permissão para transferir este ticket." },
  { id: "transfer_select_placeholder", render: () => "Selecione o novo responsável" },
  { id: "transfer_same_user", render: () => "Esse usuário já é o responsável por este ticket." },
  { id: "transfer_success", render: (ctx) => `🔄 <@${ctx.fromUserId}> transferiu o ticket para <@${ctx.toUserId}>.` },
  { id: "log_claim_title", render: () => "🖐️ Ticket assumido" },
  { id: "log_unclaim_title", render: () => "🔓 Ticket liberado" },
  { id: "log_transfer_title", render: () => "🔄 Responsável transferido" },
  { id: "log_field_channel", render: () => "Canal" },
  { id: "log_field_by", render: () => "Executado por" },
  { id: "log_field_previous", render: () => "Responsável anterior" },
  { id: "log_field_new", render: () => "Novo responsável" },
  { id: "log_none", render: () => "Ninguém" },

  { id: "participant_ticket_not_found", render: () => "❌ Não foi possível localizar os dados deste ticket." },
  { id: "participant_add_no_permission", render: () => "❌ Você não tem permissão para adicionar participantes." },
  { id: "participant_remove_no_permission", render: () => "❌ Você não tem permissão para remover participantes." },
  { id: "participant_add_placeholder", render: () => "Selecione o membro para adicionar" },
  { id: "participant_remove_placeholder", render: () => "Selecione o membro para remover" },
  { id: "participant_cannot_add_bot", render: () => "❌ Não é possível adicionar o bot como participante." },
  { id: "participant_already_in", render: (ctx) => `<@${ctx.userId}> já faz parte deste ticket.` },
  { id: "participant_add_success", render: (ctx) => `➕ <@${ctx.userId}> foi adicionado ao ticket.` },
  { id: "participant_cannot_remove_owner", render: () => "❌ Não é possível remover o criador do ticket." },
  { id: "participant_cannot_remove_bot", render: () => "❌ Não é possível remover o bot do ticket." },
  { id: "participant_remove_success", render: (ctx) => `➖ <@${ctx.userId}> foi removido do ticket.` },
  { id: "log_participant_add_title", render: () => "➕ Participante adicionado" },
  { id: "log_participant_remove_title", render: () => "➖ Participante removido" },
  { id: "log_field_participant", render: () => "Participante" },
  { id: "btn_add_participant", render: () => "➕ Adicionar Participante" },
  { id: "btn_remove_participant", render: () => "➖ Remover Participante" },
  { id: "btn_close", render: () => "🔒 Fechar Ticket" },
  { id: "action_menu_title", render: () => "🎫 Ações do Ticket" },

  { id: "faq_select_placeholder", render: () => "Selecione uma pergunta" },
  { id: "faq_open_ticket_button", render: () => "🎫 Abrir Ticket" },
  { id: "faq_close_button", render: () => "❌ Fechar" },
  { id: "faq_closed_message", render: () => "Ok! Se precisar, é só abrir um ticket novamente." },
  { id: "faq_list_title", render: () => "❓ Perguntas Frequentes" },
  { id: "faq_list_desc", render: () => "Talvez sua dúvida já tenha resposta por aqui. Escolha uma pergunta abaixo ou abra um ticket diretamente." },

  { id: "opt_template", render: () => "Biblioteca de Templates" },
  { id: "opt_template_desc", render: () => "Publicar ou instalar templates de ticket" },
  { id: "btn_template_publish", render: () => "📦 Publicar como Template" },
  { id: "btn_template_install", render: () => "📥 Instalar Template" },
  { id: "modal_template_publish_title", render: () => "Publicar Template" },
  { id: "modal_template_name_label", render: () => "Nome do template" },
  { id: "modal_template_short_desc_label", render: () => "Descrição curta" },
  { id: "modal_template_tags_label", render: () => "Tags" },
  { id: "modal_template_tags_placeholder", render: () => "suporte, vendas, comunidade" },
  { id: "template_publish_success", render: (ctx) => `✅ Template publicado! ID: \`${ctx.libId}\`` },
  { id: "template_publish_error", render: (ctx) => `❌ Erro ao publicar template: ${ctx.error}` },
  { id: "modal_template_install_title", render: () => "Instalar Template" },
  { id: "modal_template_libid_label", render: () => "ID do template" },
  { id: "template_install_success", render: (ctx) => `✅ Template instalado como novo painel: \`${ctx.panelId}\`` },
  { id: "template_install_error", render: (ctx) => `❌ Erro ao instalar template: ${ctx.error}` },
  { id: "template_menu_header", render: () => "## 📦 Biblioteca de Templates\nPublique este painel como template reutilizável ou instale um template existente como novo painel." },

  { id: "opt_claim", render: () => "Responsável (Claim)" },
  { id: "opt_claim_desc", render: () => "Configurar quem pode assumir tickets" },
  { id: "opt_participants", render: () => "Participantes" },
  { id: "opt_participants_desc", render: () => "Configurar quem pode adicionar/remover participantes" },
  { id: "opt_faq", render: () => "FAQ" },
  { id: "opt_faq_desc", render: () => "Perguntas frequentes antes de abrir o ticket" },
  { id: "opt_actionmenu", render: () => "Menu de Ações" },
  { id: "opt_actionmenu_desc", render: () => "Palavras-chave que abrem o menu de ações" },

  { id: "btn_clear_roles", render: () => "🧹 Limpar cargos" },
  { id: "claim_roles_placeholder", render: () => "Cargos que podem assumir tickets" },
  { id: "claim_log_channel_placeholder", render: () => "Canal de log de claim (opcional)" },
  { id: "claim_roles_none", render: () => "Todos os membros da equipe" },
  { id: "claim_menu_header", render: (ctx) => `## 👤 Responsável pelo Ticket (Claim)\n**Status:** ${ctx.status}\n**Cargos permitidos:** ${ctx.roles}\n**Canal de log:** ${ctx.logChannel}` },

  { id: "participants_add_roles_placeholder", render: () => "Cargos que podem adicionar participantes" },
  { id: "participants_remove_roles_placeholder", render: () => "Cargos que podem remover participantes" },
  { id: "participants_menu_header", render: (ctx) => `## 👥 Participantes\n**Podem adicionar:** ${ctx.addRoles}\n**Podem remover:** ${ctx.removeRoles}` },

  { id: "faq_add_button", render: () => "➕ Adicionar Pergunta" },
  { id: "faq_limit_reached", render: (ctx) => `❌ Limite de ${ctx.max} perguntas atingido para o seu plano.` },
  { id: "modal_faq_add_title", render: () => "Nova Pergunta Frequente" },
  { id: "modal_faq_question_label", render: () => "Pergunta" },
  { id: "modal_faq_answer_label", render: () => "Resposta" },
  { id: "faq_added_success", render: () => "✅ Pergunta adicionada!" },
  { id: "faq_remove_placeholder", render: () => "Selecione uma pergunta para remover" },
  { id: "faq_menu_header", render: (ctx) => `## ❓ FAQ Pré-Abertura\n**Status:** ${ctx.status}\n**Perguntas:** ${ctx.count}/${ctx.max}` },

  { id: "actionmenu_add_button", render: () => "➕ Nova Palavra-chave" },
  { id: "actionmenu_premium_required", render: () => "❌ Múltiplas palavras-chave são exclusivas do plano Lua Crescente." },
  { id: "modal_actionmenu_add_title", render: () => "Nova Palavra-chave" },
  { id: "modal_actionmenu_keyword_label", render: () => "Palavra-chave exata" },
  { id: "actionmenu_added_success", render: () => "✅ Palavra-chave adicionada!" },
  { id: "actionmenu_edit_placeholder", render: () => "Selecione uma palavra-chave para editar" },
  { id: "actionmenu_menu_header", render: (ctx) => `## 🎫 Menu de Ações\n**Status:** ${ctx.status}\n**Palavras-chave:** ${ctx.count}\n**Plano:** ${ctx.plan}` },
  { id: "actionmenu_plan_premium", render: () => "Lua Crescente (múltiplas palavras-chave)" },
  { id: "actionmenu_plan_free", render: () => "Gratuito (1 palavra-chave fixa)" },
  { id: "actionmenu_actions_placeholder", render: () => "Ações disponíveis neste menu" },
  { id: "actionmenu_roles_placeholder", render: () => "Cargos que podem usar esta palavra-chave" },
  { id: "actionmenu_autodelete_on", render: () => "🗑️ Apagar mensagem: Ativar" },
  { id: "actionmenu_autodelete_off", render: () => "🗑️ Apagar mensagem: Desativar" },
  { id: "actionmenu_delete_keyword", render: () => "❌ Excluir Palavra-chave" },
  { id: "actionmenu_keyword_header", render: (ctx) => `## 🔑 Palavra-chave: \`${ctx.keyword}\`\n**Ações:** ${ctx.actions}\n**Cargos permitidos:** ${ctx.roles}\n**Apagar mensagem automaticamente:** ${ctx.autoDelete}` },
];
